...
def save_json(out_data:dict, filename:str):
    ...
    output_path = Path('..') / "output_llama3" / output_file
...
if __name__ == '__main__':
    ...
    client = instructor.from_groq(client_groq)
    ...
    for data_file in data_file_list:
        ...
        json_path = Path('..') / "output_llama3" / json_file
        ...
        # validation
        struktura = validate(llm_client=client, data_structure=struktura, llm_model=MODEL)
