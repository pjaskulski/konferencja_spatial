...
def save_json(out_data:dict, filename:str):
    ...
    output_path = Path('..') / "output_deepseek" / output_file
...
def analiza(client, tekst_biogramu:str, llm_model, add_prompt=""):
    ...
    rezultat, raw_result = client.chat.completions.create_with_completion(
        model=llm_model,
        messages=[
...
if __name__ == '__main__':
    ...
    for data_file in data_file_list:
        ...
        json_path = Path('..') / "output_deepseek" / json_file
